...
with dpg.window(tag="main",label="window title"):
	...
	with dpg.group(horizontal=True):
		with dpg.child_window(width=200,tag="sidebar"):
			dpg.add_text("Music Player",color=(115, 140, 000))
			dpg.add_text("Made by Sajan")
			dpg.add_spacer(height=2)
			dpg.add_button(label="Contact me",width=-1,height=23,callback=lambda:webbrowser.open(url="https://siminikita.github.io/CV/"))
